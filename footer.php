    ...
    <div class="offcanvas offcanvas-start canvas-mb" id="mobileMenu" tabindex="-1" style="width: 380px; max-width: 90vw;">
        ...
        <div class="offcanvas-body p-3">
            <ul class="nav flex-column gap-1 mb-4 list-unstyled">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse show mt-2" id="mobileProductsCollapse">
                        <div class="mobile-accordion-group">
                            ...
                            <!-- Sub Category A: ArchLabs Seating Catalogue (Expanded by default) -->
                            <div class="mb-2">
                ...
                <!-- 3. ArchLabs Catalogue direct link -->
                <li class="nav-item">
                    <a class="mobile-nav-link text-danger" href="archlabs-catalogue.html">
                        <span>ArchLabs Catalogue</span>
                    </a>
                </li>
