                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="footer-about">
                                ...
                                <p class="text-white fw-normal fs-6 mb-3" style="line-height: 1.6; color: #e0e0e0 !important;">
                        ...
                        <div class="col-lg-2 col-md-6">
                            <h5 class="text-uppercase fw-bold text-white mb-3 pb-2 border-bottom border-danger" style="font-size: 15px; letter-spacing: 0.5px;">Quick Links</h5>
                            <ul class="list-unstyled d-flex flex-column gap-2.5 mb-0 fs-6">
                                <li><a href="index.html" class="text-white text-decoration-none hover-red py-1 d-block fw-medium">&bull; Home</a></li>
                                <li><a href="about.html" class="text-white text-decoration-none hover-red py-1 d-block fw-medium">&bull; About Us</a></li>
                                <li><a href="product-categories.html" class="text-white text-decoration-none hover-red py-1 d-block fw-medium">&bull; Products</a></li>
                                <li><a href="contact.html" class="text-white text-decoration-none hover-red py-1 d-block fw-medium">&bull; Contact Us</a></li>
                            </ul>
                        </div>

                        <!-- Product Categories -->
                        <div class="col-lg-3 col-md-6">
                            <h5 class="text-uppercase fw-bold text-white mb-3 pb-2 border-bottom border-danger" style="font-size: 15px; letter-spacing: 0.5px;">Product Categories</h5>
                            <div class="row g-2 fs-6">
                                <div class="col-6">
                                    <ul class="list-unstyled d-flex flex-column gap-2 mb-0">
                                        <li><a href="product-categories.html#workstations" class="text-white text-decoration-none hover-red py-1 d-block fw-medium">&bull; Workstations</a></li>
                                        <li><a href="product-categories.html#tables" class="text-white text-decoration-none hover-red py-1 d-block fw-medium">&bull; Tables</a></li>
                                        <li><a href="product-categories.html#storage" class="text-white text-decoration-none hover-red py-1 d-block fw-medium">&bull; Storage</a></li>
                                        <li><a href="archlabs-catalogue.html" class="text-white text-decoration-none hover-red py-1 d-block fw-medium">&bull; Seating</a></li>
                                    </ul>
                                </div>
                                <div class="col-6">
                                    <ul class="list-unstyled d-flex flex-column gap-2 mb-0">
                                        <li><a href="product-sofas.html" class="text-white text-decoration-none hover-red py-1 d-block fw-medium">&bull; Soft Seating</a></li>
                                        <li><a href="product-categories.html#pods" class="text-white text-decoration-none hover-red py-1 d-block fw-medium">&bull; Pods</a></li>
                                        <li><a href="product-categories.html#educational" class="text-white text-decoration-none hover-red py-1 d-block fw-medium">&bull; Educational</a></li>
                                        <li><a href="product-categories.html#accessories" class="text-white text-decoration-none hover-red py-1 d-block fw-medium">&bull; Accessories</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Contact Details -->
                        <div class="col-lg-3 col-md-6">
                            <h5 class="text-uppercase fw-bold text-white mb-3 pb-2 border-bottom border-danger" style="font-size: 15px; letter-spacing: 0.5px;">Contact Us</h5>
                            <div class="d-flex flex-column gap-3 fs-6 text-white">
                                <div class="footer-contact-block">
                                    <strong class="text-danger d-block mb-1 fs-6 text-uppercase tracking-wider">&bull; Head Office:</strong>
                                    <span style="line-height: 1.6; display: block; color: #ffffff !important; font-weight: 500;">
                                ...
                                <div class="footer-contact-block">
                                    <strong class="text-danger d-block mb-1 fs-6 text-uppercase tracking-wider">&bull; Emails:</strong>
                                    <div class="d-flex flex-column gap-1" style="font-weight: 500;">
                                ...
                                <div class="footer-contact-block">
                                    <strong class="text-danger d-block mb-1 fs-6 text-uppercase tracking-wider">&bull; WhatsApp &amp; Sales:</strong>
                                    <a href="https://wa.me/919849058444" target="_blank" class="text-white fs-6 fw-bold text-decoration-none d-inline-block hover-red">&bull; +91 9849058444</a>
                                </div>
                                <div class="pt-1">
