            ...
            <div class="modal-content border-0 shadow-lg" style="border-radius: 12px; overflow: hidden;">
                ...
                <div class="modal-body p-4 bg-white">
                    <form id="modalEnquiryForm" onsubmit="handleEnquirySubmit(event)">
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-danger w-100 justify-content-center text-uppercase fw-extrabold shadow-sm py-3" style="border-radius: 6px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none; font-size: 15px; letter-spacing: 0.5px;">Submit Enquiry</button>
                        </div>
                    </form>
                </div>
            </div>
