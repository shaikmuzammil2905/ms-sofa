        ...
        <div class="row g-5">
            ...
            <div class="col-lg-5">
                <div class="h-100">
                    ...
                    <div class="card border-0 shadow-lg p-4 rounded-4 bg-dark text-white h-100 d-flex flex-column justify-content-between">
                        <div>
                            <span class="text-danger fw-black text-uppercase tracking-wider d-block mb-2" style="font-size: 1.15rem !important; letter-spacing: 1.5px; color: #ff5252 !important;">Corporate Office</span>
                            <h3 class="fw-black text-white mb-3" style="font-size: 1.8rem !important; font-weight: 900 !important;">Vishista Office Solutions Pvt Ltd</h3>
                            
                            <div class="d-flex gap-3 mb-3">
                                <div class="text-danger fs-3"><i class="icon icon-storefront"></i></div>
                                <div>
                                    <strong class="text-white fs-6">Registered Address:</strong>
                                    <p class="text-white-50 mb-0 fs-6" style="line-height: 1.6;">
                        ...
                        <div class="rounded-3 overflow-hidden my-3 shadow" style="border: 2px solid rgba(255,255,255,0.15);">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3805.5186256247926!2d78.4756593!3d17.4827598!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb9a918a38ef2f%3A0x4a9b2b52fa102434!2sSaishruthi%20Nilyam%2C%20Street%20No.%204%2C%20Sri%20Sathya%20Sai%20Enclave%2C%20Old%20Bowenpally%2C%20Secunderabad%2C%20Telangana%20500009!5e0!3m2!1sen!2sin!4v1710000000000!5m2!1sen!2sin" width="100%" height="280" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
