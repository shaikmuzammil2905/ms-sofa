    ...
    <div class="tf-container">
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#workstations-ha" target="_blank"><img src="images/categories/cat_workstations.jpg" alt="Height Adjustable Series" class="card-img-top" style="background: #ffffff; height: 240px; object-fit: cover;"></a>
                ...
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#workstations-ds" target="_blank"><img src="images/sections/hero-workspace.jpg" alt="Desking Series" class="card-img-top" style="background: #ffffff; height: 240px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <a href="archlabs-catalogue.html#workstations-ds" target="_blank" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md text-center" style="font-size: 1.15rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;">VIEW PRODUCT CATALOGUE &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#workstations-ps" target="_blank"><img src="images/sections/s-lookbook-2.jpg" alt="Panel Series" class="card-img-top" style="background: #ffffff; height: 240px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <a href="archlabs-catalogue.html#workstations-ps" target="_blank" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md text-center" style="font-size: 1.15rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;">VIEW PRODUCT CATALOGUE &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="tables" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#tables-cabin" target="_blank"><img src="images/categories/cat_tables.png" alt="Cabin Tables" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                ...
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#tables-meeting" target="_blank"><img src="images/categories/cat_tables.jpg" alt="Meeting Tables" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <a href="archlabs-catalogue.html#tables-meeting" target="_blank" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md text-center" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;">VIEW PRODUCT CATALOGUE &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#tables-cafe" target="_blank"><img src="images/sections/vishista_exclusive.jpg" alt="Cafe Tables" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <a href="archlabs-catalogue.html#tables-cafe" target="_blank" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md text-center" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;">VIEW PRODUCT CATALOGUE &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#tables-training" target="_blank"><img src="images/archlabs/pages/page_43.png" alt="Training Tables" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: contain;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <a href="archlabs-catalogue.html#tables-training" target="_blank" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md text-center" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;">VIEW PRODUCT CATALOGUE &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="storage" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#storage-prelam" target="_blank"><img src="images/categories/cat_storage.png" alt="Prelam Storage" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <a href="archlabs-catalogue.html#storage-prelam" target="_blank" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md text-center" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;">VIEW PRODUCT CATALOGUE &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#storage-metal" target="_blank"><img src="images/categories/cat_storage.jpg" alt="Metal Storage" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <a href="archlabs-catalogue.html#storage-metal" target="_blank" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md text-center" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;">VIEW PRODUCT CATALOGUE &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#storage-compactor" target="_blank"><img src="images/header/prd-nav-1.jpg" alt="Compactor Storage" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <a href="archlabs-catalogue.html#storage-compactor" target="_blank" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md text-center" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;">VIEW PRODUCT CATALOGUE &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#storage-lockers" target="_blank"><img src="images/header/prd-nav-2.jpg" alt="Lockers" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <a href="archlabs-catalogue.html#storage-lockers" target="_blank" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md text-center" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;">VIEW PRODUCT CATALOGUE &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="seating" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#mesh-series" target="_blank"><img src="images/archlabs/pages/page_4.png" alt="Mesh Chair" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: contain;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <a href="archlabs-catalogue.html#mesh-series" target="_blank" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md text-center" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;">VIEW PRODUCT CATALOGUE &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#leather-series" target="_blank"><img src="images/archlabs/pages/page_36.png" alt="Leather Chair" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: contain;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <a href="archlabs-catalogue.html#leather-series" target="_blank" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md text-center" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;">VIEW PRODUCT CATALOGUE &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#training-series" target="_blank"><img src="images/archlabs/pages/page_43.png" alt="Training Chair" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: contain;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <a href="archlabs-catalogue.html#training-series" target="_blank" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md text-center" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;">VIEW PRODUCT CATALOGUE &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#cafeteria-series" target="_blank"><img src="images/archlabs/pages/page_57.png" alt="Cafe Chair" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: contain;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <a href="archlabs-catalogue.html#cafeteria-series" target="_blank" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md text-center" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;">VIEW PRODUCT CATALOGUE &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="soft-seating" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="product-sofas.html" target="_blank"><img src="images/categories/cat_soft_seating.jpg" alt="Lounge & Sofas" class="card-img-top" style="background: #ffffff; height: 240px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <a href="product-sofas.html" target="_blank" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md text-center" style="font-size: 1.15rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;">VIEW PRODUCT CATALOGUE &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="product-sofas.html#collaborative" target="_blank"><img src="images/collection/collection-1.jpg" alt="Collaborative Seating" class="card-img-top" style="background: #ffffff; height: 240px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <a href="product-sofas.html#collaborative" target="_blank" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md text-center" style="font-size: 1.15rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;">VIEW PRODUCT CATALOGUE &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="product-sofas.html#pouffes" target="_blank"><img src="images/collection/collection-2.jpg" alt="Pouffes & Tables" class="card-img-top" style="background: #ffffff; height: 240px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <a href="product-sofas.html#pouffes" target="_blank" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md text-center" style="font-size: 1.15rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;">VIEW PRODUCT CATALOGUE &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="pods" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#pods" target="_blank"><img src="images/categories/cat_pods.jpg" alt="Single Phone Pod" class="card-img-top" style="background: #ffffff; height: 260px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <a href="archlabs-catalogue.html#pods" target="_blank" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md text-center" style="font-size: 1.15rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;">VIEW PRODUCT CATALOGUE &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#pods" target="_blank"><img src="images/sections/hero-workspace.jpg" alt="Meeting Pod" class="card-img-top" style="background: #ffffff; height: 260px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
        ...
        <section id="carpets" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#carpets" target="_blank"><img src="images/categories/cat_carpets.jpg" alt="Interface Carpet Tiles" class="card-img-top" style="background: #ffffff; height: 260px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <a href="archlabs-catalogue.html#carpets" target="_blank" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md text-center" style="font-size: 1.15rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;">VIEW PRODUCT CATALOGUE &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="outdoor" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#outdoor" target="_blank"><img src="images/categories/cat_outdoor.jpg" alt="Loom Crafts Outdoor" class="card-img-top" style="background: #ffffff; height: 260px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <a href="archlabs-catalogue.html#outdoor" target="_blank" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md text-center" style="font-size: 1.15rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;">VIEW PRODUCT CATALOGUE &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="educational" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#educational" target="_blank"><img src="images/categories/cat_education.png" alt="Classroom Desks" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <a href="archlabs-catalogue.html#educational" target="_blank" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md text-center" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;">VIEW PRODUCT CATALOGUE &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#educational" target="_blank"><img src="images/categories/cat_educational.jpg" alt="Library Units" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                ...
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#educational" target="_blank"><img src="images/sections/s-lookbook-1.jpg" alt="Hostel Furniture" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                ...
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#educational" target="_blank"><img src="images/categories/cat_seating.jpg" alt="Auditorium Seating" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
        ...
        <section id="accessories" class="mb-4 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#accessories" target="_blank"><img src="images/categories/cat_workstations.jpg" alt="Workspace Accessories" class="card-img-top" style="background: #ffffff; height: 260px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <a href="archlabs-catalogue.html#accessories" target="_blank" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md text-center" style="font-size: 1.15rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;">VIEW PRODUCT CATALOGUE &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
