    ...
    <div class="tf-container">
        ...
        <section id="workstations" class="mb-5 pt-4">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#workstations-ds" target="_blank"><img src="images/categories/cat_workstations.jpg" alt="Desking Series" class="card-img-top" style="background: #ffffff; height: 240px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                ...
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#workstations-ps" target="_blank"><img src="images/categories/cat_workstations.jpg" alt="Panel Series" class="card-img-top" style="background: #ffffff; height: 240px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
        ...
        <section id="tables" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#tables-meeting" target="_blank"><img src="images/categories/cat_tables.png" alt="Meeting Tables" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                ...
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#tables-cafe" target="_blank"><img src="images/categories/cat_tables.png" alt="Cafe Tables" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                ...
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#tables-training" target="_blank"><img src="images/categories/cat_tables.png" alt="Training Tables" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
        ...
        <section id="storage" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#storage-metal" target="_blank"><img src="images/categories/cat_storage.png" alt="Metal Storage" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                ...
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#storage-compactor" target="_blank"><img src="images/categories/cat_storage.png" alt="Compactor Storage" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                ...
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#storage-lockers" target="_blank"><img src="images/categories/cat_storage.png" alt="Lockers" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
        ...
        <section id="soft-seating" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="product-sofas.html" target="_blank"><img src="images/categories/cat_soft_seating.jpg" alt="Collaborative Seating" class="card-img-top" style="background: #ffffff; height: 240px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                ...
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="product-sofas.html" target="_blank"><img src="images/categories/cat_soft_seating.jpg" alt="Pouffes & Tables" class="card-img-top" style="background: #ffffff; height: 240px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
        ...
        <section id="pods" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#pods" target="_blank"><img src="images/categories/cat_pods.jpg" alt="Meeting Pod" class="card-img-top" style="background: #ffffff; height: 260px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
        ...
        <section id="carpets" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#carpets" target="_blank"><img src="images/categories/cat_workstations.jpg" alt="Interface Carpet Tiles" class="card-img-top" style="background: #ffffff; height: 260px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
        ...
        <section id="outdoor" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#outdoor" target="_blank"><img src="images/categories/cat_tables.png" alt="Loom Crafts Outdoor" class="card-img-top" style="background: #ffffff; height: 260px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
        ...
        <section id="educational" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#educational" target="_blank"><img src="images/categories/cat_education.png" alt="Library Units" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                ...
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#educational" target="_blank"><img src="images/categories/cat_education.png" alt="Hostel Furniture" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
                ...
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="archlabs-catalogue.html#educational" target="_blank"><img src="images/categories/cat_education.png" alt="Auditorium Seating" class="card-img-top" style="background: #ffffff; height: 220px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
