    ...
    <div class="tf-container">
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_workstations.jpg" alt="Height Adjustable Series" class="card-img-top cursor-pointer" style="background: #ffffff; height: 240px; object-fit: cover;" onclick="openProductCategoryPopup('Height Adjustable Series')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.15rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Height Adjustable Series')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_workstations.jpg" alt="Desking Series" class="card-img-top cursor-pointer" style="background: #ffffff; height: 240px; object-fit: cover;" onclick="openProductCategoryPopup('Desking Series')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.15rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Desking Series')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_workstations.jpg" alt="Panel Series" class="card-img-top cursor-pointer" style="background: #ffffff; height: 240px; object-fit: cover;" onclick="openProductCategoryPopup('Panel Series')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.15rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Panel Series')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="tables" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_tables.png" alt="Cabin Tables" class="card-img-top cursor-pointer" style="background: #ffffff; height: 220px; object-fit: cover;" onclick="openProductCategoryPopup('Cabin Tables')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Cabin Tables')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_tables.png" alt="Meeting Tables" class="card-img-top cursor-pointer" style="background: #ffffff; height: 220px; object-fit: cover;" onclick="openProductCategoryPopup('Meeting Tables')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Meeting Tables')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_tables.png" alt="Cafe Tables" class="card-img-top cursor-pointer" style="background: #ffffff; height: 220px; object-fit: cover;" onclick="openProductCategoryPopup('Cafe Tables')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Cafe Tables')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_tables.png" alt="Training Tables" class="card-img-top cursor-pointer" style="background: #ffffff; height: 220px; object-fit: cover;" onclick="openProductCategoryPopup('Training Tables')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Training Tables')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="storage" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_storage.png" alt="Prelam Storage" class="card-img-top cursor-pointer" style="background: #ffffff; height: 220px; object-fit: cover;" onclick="openProductCategoryPopup('Prelam Storage')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Prelam Storage')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_storage.png" alt="Metal Storage" class="card-img-top cursor-pointer" style="background: #ffffff; height: 220px; object-fit: cover;" onclick="openProductCategoryPopup('Metal Storage')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Metal Storage')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_storage.png" alt="Compactor Storage" class="card-img-top cursor-pointer" style="background: #ffffff; height: 220px; object-fit: cover;" onclick="openProductCategoryPopup('Compactor Storage')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Compactor Storage')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_storage.png" alt="Lockers" class="card-img-top cursor-pointer" style="background: #ffffff; height: 220px; object-fit: cover;" onclick="openProductCategoryPopup('Locker Systems')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Locker Systems')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="seating" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/archlabs/pages/page_4.png" alt="Mesh Chair" class="card-img-top cursor-pointer" style="background: #ffffff; height: 220px; object-fit: contain;" onclick="openProductCategoryPopup('Mesh Chairs (30 Models)')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Mesh Chairs (30 Models)')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/archlabs/pages/page_36.png" alt="Leather Chair" class="card-img-top cursor-pointer" style="background: #ffffff; height: 220px; object-fit: contain;" onclick="openProductCategoryPopup('Leather Chairs (5 Models)')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Leather Chairs (5 Models)')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/archlabs/pages/page_43.png" alt="Training Chair" class="card-img-top cursor-pointer" style="background: #ffffff; height: 220px; object-fit: contain;" onclick="openProductCategoryPopup('Training Chairs (7 Models)')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Training Chairs (7 Models)')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/archlabs/pages/page_57.png" alt="Cafe Chair" class="card-img-top cursor-pointer" style="background: #ffffff; height: 220px; object-fit: contain;" onclick="openProductCategoryPopup('Cafe Chairs (7 Models)')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Cafe Chairs (7 Models)')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="soft-seating" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_soft_seating.jpg" alt="Lounge & Sofas" class="card-img-top cursor-pointer" style="background: #ffffff; height: 240px; object-fit: cover;" onclick="openProductCategoryPopup('Lounge & Executive Sofas')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.15rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Lounge & Executive Sofas')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_soft_seating.jpg" alt="Collaborative Seating" class="card-img-top cursor-pointer" style="background: #ffffff; height: 240px; object-fit: cover;" onclick="openProductCategoryPopup('Collaborative Seating')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.15rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Collaborative Seating')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_soft_seating.jpg" alt="Pouffes & Tables" class="card-img-top cursor-pointer" style="background: #ffffff; height: 240px; object-fit: cover;" onclick="openProductCategoryPopup('Pouffes & Occasional Tables')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.15rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Pouffes & Occasional Tables')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="pods" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_pods.jpg" alt="Single Phone Pod" class="card-img-top cursor-pointer" style="background: #ffffff; height: 260px; object-fit: cover;" onclick="openProductCategoryPopup('Single Acoustic Phone Pod')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.15rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Single Acoustic Phone Pod')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_pods.jpg" alt="Meeting Pod" class="card-img-top cursor-pointer" style="background: #ffffff; height: 260px; object-fit: cover;" onclick="openProductCategoryPopup('4-6 Person Meeting Pod')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.15rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('4-6 Person Meeting Pod')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="carpets" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_workstations.jpg" alt="Interface Carpet Tiles" class="card-img-top cursor-pointer" style="background: #ffffff; height: 260px; object-fit: cover;" onclick="openProductCategoryPopup('Interface Carpet Tiles')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.15rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Interface Carpet Tiles')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="outdoor" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_tables.png" alt="Loom Crafts Outdoor" class="card-img-top cursor-pointer" style="background: #ffffff; height: 260px; object-fit: cover;" onclick="openProductCategoryPopup('Loom Crafts Terrace & Cafe Seating')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.15rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Loom Crafts Terrace & Cafe Seating')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="educational" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_education.png" alt="Classroom Desks" class="card-img-top cursor-pointer" style="background: #ffffff; height: 220px; object-fit: cover;" onclick="openProductCategoryPopup('Classroom Desks')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Classroom Desks')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_education.png" alt="Library Units" class="card-img-top cursor-pointer" style="background: #ffffff; height: 220px; object-fit: cover;" onclick="openProductCategoryPopup('Library Furniture')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Library Furniture')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_education.png" alt="Hostel Furniture" class="card-img-top cursor-pointer" style="background: #ffffff; height: 220px; object-fit: cover;" onclick="openProductCategoryPopup('Hostel Furniture')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Hostel Furniture')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_education.png" alt="Auditorium Seating" class="card-img-top cursor-pointer" style="background: #ffffff; height: 220px; object-fit: cover;" onclick="openProductCategoryPopup('Auditorium Seating')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.1rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Auditorium Seating')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="accessories" class="mb-4 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <img src="images/categories/cat_workstations.jpg" alt="Workspace Accessories" class="card-img-top cursor-pointer" style="background: #ffffff; height: 260px; object-fit: cover;" onclick="openProductCategoryPopup('Ergonomic Arms & Power Management')">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-grid mt-auto">
                                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black py-3 shadow-md" style="font-size: 1.15rem !important; letter-spacing: 0.8px; border-radius: 8px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none;" onclick="openProductCategoryPopup('Ergonomic Arms & Power Management')">VIEW PRODUCT CATALOGUE &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Product Category Specific Popup Modal -->
<div class="modal fade" id="productCategoryModalPopup" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="bg-dark text-white p-4 d-flex justify-content-between align-items-center" style="background: linear-gradient(135deg, #111111 0%, #2b2b2b 100%) !important;">
                <div>
                    ...
                    <h3 class="fw-black text-white mb-0" id="catPopupTitle" style="font-size: 1.8rem !important; font-weight: 900 !important;">Product Catalogue</h3>
                </div>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-4 bg-light">
                <p class="text-dark fw-semibold fs-6 mb-4" id="catPopupSubtitle" style="color: #333333 !important;"></p>
                
                <!-- Dynamic Models Grid -->
                <div class="row g-4" id="catPopupGridContainer">
            ...
            <div class="modal-footer bg-white p-3 d-flex justify-content-between align-items-center">
                ...
                <button type="button" class="btn btn-danger btn-lg text-uppercase fw-black px-4 py-2" id="catPopupEnquireBtn" style="border-radius: 6px; background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%); border: none; font-size: 1rem !important;">Enquire For This Catalogue &rarr;</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    var popupCatalogueData = {
        ...
        "Cabin Tables": {
            ...
            items: [
                ...
                { name: "Model CB-Managerial Side Return Desk", img: "images/categories/cat_tables.jpg", specs: "Prelam Wood Finish / Lockable Drawers / Wire Grommets" },
    ...
    function openProductCategoryPopup(productName) {
        var data = popupCatalogueData[productName] || {
        ...
        document.getElementById('catPopupTitle').innerText = productName + " Catalogue";
        document.getElementById('catPopupSubtitle').innerText = data.subtitle;
        
        var grid = document.getElementById('catPopupGridContainer');
        grid.innerHTML = '';
            ...
            col.innerHTML = `
                <div class="card border h-100 shadow-sm rounded-4 overflow-hidden bg-white">
                    ...
                    <div class="card-body p-4 d-flex flex-column">
                        ...
                        <button type="button" class="btn btn-outline-danger btn-sm text-uppercase fw-black py-2 mt-auto" style="border-radius: 6px; font-size: 0.9rem !important;" onclick="closeCategoryPopupAndEnquire('${item.name}')">Enquire For This Model &rarr;</button>
                    </div>
                </div>
            `;
        ...
        document.getElementById('catPopupEnquireBtn').onclick = function() {
            var catModal = bootstrap.Modal.getInstance(document.getElementById('productCategoryModalPopup'));
            if (catModal) catModal.hide();
            openEnquiryModal(productName + ' Catalogue');
        };

        var modal = new bootstrap.Modal(document.getElementById('productCategoryModalPopup'));
        modal.show();
    }

    function closeCategoryPopupAndEnquire(itemName) {
        var catModal = bootstrap.Modal.getInstance(document.getElementById('productCategoryModalPopup'));
        if (catModal) catModal.hide();
