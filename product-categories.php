    ...
    <div class="tf-container">
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-3 overflow-hidden">
                        <img src="images/categories/cat_workstations.jpg" alt="Height Adjustable Series" class="card-img-top" style="background: #ffffff;">
                ...
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-3 overflow-hidden">
                        <img src="images/categories/cat_workstations.jpg" alt="Desking Series" class="card-img-top" style="background: #ffffff;">
                        <div class="card-body p-4 d-flex flex-column">
                            <span class="badge bg-light text-dark border align-self-start mb-2 fs-7">VIAK Catalogue</span>
                ...
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-3 overflow-hidden">
                        <img src="images/categories/cat_workstations.jpg" alt="Panel Series" class="card-img-top" style="background: #ffffff;">
                        <div class="card-body p-4 d-flex flex-column">
                            <span class="badge bg-light text-dark border align-self-start mb-2 fs-7">VIAK Catalogue</span>
        ...
        <section id="tables" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-3 overflow-hidden">
                        <img src="images/categories/cat_tables.jpg" alt="Cabin Tables" class="card-img-top" style="background: #ffffff;">
                ...
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-3 overflow-hidden">
                        <img src="images/categories/cat_tables.jpg" alt="Meeting Tables" class="card-img-top" style="background: #ffffff;">
                        <div class="card-body p-3 d-flex flex-column">
                ...
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-3 overflow-hidden">
                        <img src="images/categories/cat_tables.jpg" alt="Cafe Tables" class="card-img-top" style="background: #ffffff;">
                        <div class="card-body p-3 d-flex flex-column">
                ...
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-3 overflow-hidden">
                        <img src="images/categories/cat_tables.jpg" alt="Training Tables" class="card-img-top" style="background: #ffffff;">
                        <div class="card-body p-3 d-flex flex-column">
        ...
        <section id="storage" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-3 overflow-hidden">
                        <img src="images/categories/cat_storage.jpg" alt="Prelam Storage" class="card-img-top" style="background: #ffffff;">
                        <div class="card-body p-3 d-flex flex-column">
                ...
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-3 overflow-hidden">
                        <img src="images/categories/cat_storage.jpg" alt="Metal Storage" class="card-img-top" style="background: #ffffff;">
                        <div class="card-body p-3 d-flex flex-column">
                ...
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-3 overflow-hidden">
                        <img src="images/categories/cat_storage.jpg" alt="Compactor Storage" class="card-img-top" style="background: #ffffff;">
                        <div class="card-body p-3 d-flex flex-column">
                ...
                <div class="col-md-3">
                    <div class="card border h-100 shadow-sm rounded-3 overflow-hidden">
                        <img src="images/categories/cat_storage.jpg" alt="Lockers" class="card-img-top" style="background: #ffffff;">
                        <div class="card-body p-3 d-flex flex-column">
        ...
        <section id="soft-seating" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-3 overflow-hidden">
                        <img src="images/categories/cat_soft_seating.jpg" alt="Lounge & Sofas" class="card-img-top" style="background: #ffffff;">
                        <div class="card-body p-4 d-flex flex-column">
                ...
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-3 overflow-hidden">
                        <img src="images/categories/cat_soft_seating.jpg" alt="Collaborative Seating" class="card-img-top" style="background: #ffffff;">
                        <div class="card-body p-4 d-flex flex-column">
                ...
                <div class="col-md-4">
                    <div class="card border h-100 shadow-sm rounded-3 overflow-hidden">
                        <img src="images/categories/cat_soft_seating.jpg" alt="Pouffes & Tables" class="card-img-top" style="background: #ffffff;">
                        <div class="card-body p-4 d-flex flex-column">
        ...
        <section id="pods" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card border h-100 shadow-sm rounded-3 overflow-hidden">
                        <img src="images/categories/cat_pods.jpg" alt="Single Phone Pod" class="card-img-top" style="background: #ffffff;">
                        <div class="card-body p-4 d-flex flex-column">
                ...
                <div class="col-md-6">
                    <div class="card border h-100 shadow-sm rounded-3 overflow-hidden">
                        <img src="images/categories/cat_pods.jpg" alt="Meeting Pod" class="card-img-top" style="background: #ffffff;">
                        <div class="card-body p-4 d-flex flex-column">
        ...
        <section id="carpets" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card border h-100 shadow-sm rounded-3 overflow-hidden">
                        <img src="images/categories/cat_workstations.jpg" alt="Interface Carpet Tiles" class="card-img-top" style="background: #ffffff;">
                        <div class="card-body p-4 d-flex flex-column">
        ...
        <section id="outdoor" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card border h-100 shadow-sm rounded-3 overflow-hidden">
                        <img src="images/categories/cat_tables.jpg" alt="Loom Crafts Outdoor" class="card-img-top" style="background: #ffffff;">
                        <div class="card-body p-4 d-flex flex-column">
