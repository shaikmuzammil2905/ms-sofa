    ...
    <div class="tf-container">
        ...
        <section id="outdoor" class="mb-5 pt-4 border-top">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                        <a href="products.html?category=outdoor"><img src="images/categories/cat_outdoor.jpg" alt="Loom Crafts Outdoor" class="card-img-top" style="background: #ffffff; height: 260px; object-fit: cover;"></a>
                        <div class="card-body p-4 d-flex flex-column">
