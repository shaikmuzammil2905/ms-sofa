...
<div class="bg-white border-bottom py-3 category-jump-bar" style="background-color: #ffffff !important; border-bottom: 3px solid #d32f2f !important; overflow-x: auto;">
    <div class="tf-container">
        <div class="d-flex align-items-center gap-2 text-nowrap py-1">
            ...
            <a href="#workstations" class="btn rounded-pill px-3 py-2 text-uppercase category-jump-btn flex-shrink-0">Workstations</a>
            <a href="#tables" class="btn rounded-pill px-3 py-2 text-uppercase category-jump-btn flex-shrink-0">Tables</a>
            <a href="#storage" class="btn rounded-pill px-3 py-2 text-uppercase category-jump-btn flex-shrink-0">Storage</a>
            <a href="#seating" class="btn rounded-pill px-3 py-2 text-uppercase category-jump-btn flex-shrink-0">Seating</a>
            <a href="#soft-seating" class="btn rounded-pill px-3 py-2 text-uppercase category-jump-btn flex-shrink-0">Soft Seating</a>
            <a href="#pods" class="btn rounded-pill px-3 py-2 text-uppercase category-jump-btn flex-shrink-0">Pods</a>
            <a href="#carpets" class="btn rounded-pill px-3 py-2 text-uppercase category-jump-btn flex-shrink-0">Carpets</a>
            <a href="#outdoor" class="btn rounded-pill px-3 py-2 text-uppercase category-jump-btn flex-shrink-0">Outdoor</a>
            <a href="#educational" class="btn rounded-pill px-3 py-2 text-uppercase category-jump-btn flex-shrink-0">Educational</a>
        </div>
    </div>
</div>

<style>
    /* Prevent sticky header from covering sections when using anchor links */
    section[id] {
...
<script>
    // Smooth scroll offset for anchor links (account for header height only)
    document.addEventListener('DOMContentLoaded', function() {
        document.querySelectorAll('a[href^="#"]').forEach(function(link) {
            link.addEventListener('click', function(e) {
                ...
                var jumpBar = document.querySelector('.category-jump-bar');
                var jumpH = jumpBar ? jumpBar.offsetHeight : 0;
                var offset = headerH + jumpH + 16;
