...
<section class="py-5 bg-white border-top">
    <div class="tf-container py-4">
        <div class="d-flex flex-wrap justify-content-between align-items-end mb-4">
            <div>
                <span class="text-danger fw-black text-uppercase tracking-wider d-block mb-2" style="font-size: 1.15rem !important; letter-spacing: 1.5px; font-weight: 800 !important; color: #d32f2f !important;">Our Portfolio</span>
                <h2 class="display-6 fw-extrabold text-dark mb-0" style="font-weight: 800 !important;">Featured Projects &amp; Installations</h2>
            </div>
            <p class="text-secondary fw-semibold mb-0" style="max-width: 480px; font-size: 1.05rem;">Turnkey workspace installations delivered for enterprise tech hubs and global corporate headquarters.</p>
        </div>
