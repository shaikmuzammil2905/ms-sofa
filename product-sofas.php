...
<section class="py-5 bg-dark text-white text-center position-relative" style="background: linear-gradient(rgba(0,0,0,0.75), rgba(0,0,0,0.75)), url('images/collection/collection-1.jpg') center/cover no-repeat;">
    <div class="tf-container py-4">
        <span class="badge bg-danger text-uppercase px-3 py-2 mb-3 fw-bold tracking-widest fs-7">Soft Seating &amp; Lounge Catalogue</span>
        ...
        <p class="fs-5 text-white-50 max-w-700 mx-auto" style="max-width: 750px;">
            Designed for corporate lounges, breakout zones, executive cabins, and reception lobbies.
        </p>
    </div>
</section>
...
<div class="py-5 bg-white">
    <div class="tf-container">
        ...
        <div class="row g-4 mb-5">
            <!-- Lounge Chair -->
            <div class="col-lg-4 col-md-6" id="lounge-sofas">
                <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                    <img src="images/categories/cat_soft_seating.jpg" alt="Executive Lounge Chair" class="card-img-top" style="background: #ffffff; height: 240px; object-fit: cover;">
                    <div class="card-body p-4 d-flex flex-column">
                        <span class="badge bg-light text-danger border align-self-start mb-2 fs-7">Soft Seating</span>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                    <img src="images/collection/collection-1.jpg" alt="Executive Sofas" class="card-img-top" style="background: #ffffff; height: 240px; object-fit: cover;">
                    <div class="card-body p-4 d-flex flex-column">
                        <span class="badge bg-light text-danger border align-self-start mb-2 fs-7">Soft Seating</span>
            ...
            <div class="col-lg-4 col-md-6" id="collaborative">
                <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                    <img src="images/collection/collection-2.jpg" alt="Collaborative Seating" class="card-img-top" style="background: #ffffff; height: 240px; object-fit: cover;">
                    <div class="card-body p-4 d-flex flex-column">
                        <span class="badge bg-light text-danger border align-self-start mb-2 fs-7">Collaborative</span>
            ...
            <!-- Pouffes -->
            <div class="col-lg-4 col-md-6" id="pouffes">
                <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                    <img src="images/sections/s-lookbook-1.jpg" alt="Modular Pouffes" class="card-img-top" style="background: #ffffff; height: 240px; object-fit: cover;">
                    <div class="card-body p-4 d-flex flex-column">
                        <span class="badge bg-light text-danger border align-self-start mb-2 fs-7">Pouffes &amp; Ottomans</span>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card border h-100 shadow-sm rounded-4 overflow-hidden">
                    <img src="images/categories/cat_tables.png" alt="Occasional Tables" class="card-img-top" style="background: #ffffff; height: 240px; object-fit: cover;">
                    <div class="card-body p-4 d-flex flex-column">
                        <span class="badge bg-light text-danger border align-self-start mb-2 fs-7">Coffee Tables</span>
